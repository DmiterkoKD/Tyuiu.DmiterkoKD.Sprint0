using Tyuiu.DmiterkoKD.Sprint0.Task7.V0.Lib;
namespace Tyuiu.DmiterkoKD.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнила: Дмитерко К.Д. | ИБКСб-24-1";
            Console.WriteLine("***************************************************************************");
            ...
            Console.WriteLine("* одиннаковвых массивов по длине.                                         *");
            Console.WriteLine("***************************************************************************");
            ...
            if (arrayNums1.Length == arrayNums2.Length)
            {
                ...
                Console.WriteLine("Сумма элеметов масива равны: ");
